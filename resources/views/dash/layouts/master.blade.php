...
<!-- Mirrored from phpstack-1384472-5121645.cloudwaysapps.com/template/html/ki-admin/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Jun 2025 19:45:07 GMT -->
<head>
    ...
    <link href="{{asset('dash/assets/images/logo/favicon.png')}}" rel="shortcut icon" type="image/x-icon">
    <title>Ecommerce Dashboard | ki-admin - Premium Admin Template</title>

    <!-- Animation css -->
    <link href="{{asset('dash/assets/vendor/animation/animate.min.css')}}" rel="stylesheet">
    ...
    <!--flag Icon css-->
    <link href="{{asset('dash/assets/vendor/flag-icons-master/flag-icon.css')}}" rel="stylesheet" type="text/css">

    <!-- tabler icons-->
    <link href="{{asset('dash/assets/vendor/tabler-icons/tabler-icons.css')}}" rel="stylesheet" type="text/css">

    <!-- apexcharts css-->
    <link href="{{asset('dash/assets/vendor/apexcharts/apexcharts.css')}}" rel="stylesheet" type="text/css">

    <!-- glight css -->
    <link href="{{asset('dash/assets/vendor/glightbox/glightbox.min.css')}}" rel="stylesheet">

    <!-- Bootstrap css-->
    <link href="{{asset('dash/assets/vendor/bootstrap/bootstrap.min.css')}}" rel="stylesheet" type="text/css">

    <!-- simplebar css-->
    <link href="{{asset('dash/assets/vendor/simplebar/simplebar.css')}}" rel="stylesheet" type="text/css">
            ...
            <ul class="main-nav p-0 mt-2">
                ...
                <li>
                    <a aria-expanded="false" data-bs-toggle="collapse" href="#dashboard">
                        <svg stroke="currentColor" stroke-width="1.5">
                            <use xlink:href="https://phpstack-1384472-5121645.cloudwaysapps.com/template/html/ki-adm{{asset('dash/assets/svg/_sprite.svg#home"></use>
                        </svg>
                        dashboard
                ...
                <li>
                    <a aria-expanded="false" data-bs-toggle="collapse" href="#ui-kits">
                        <svg stroke="currentColor" stroke-width="1.5">
                            <use xlink:href="https://phpstack-1384472-5121645.cloudwaysapps.com/template/html/ki-adm{{asset('dash/assets/svg/_sprite.svg#briefcase"></use>
                        </svg>
                        UI kits
                    </a>
                ...
                <li>
                    <a aria-expanded="false" data-bs-toggle="collapse" href="#advance-ui">
                        <svg stroke="currentColor" stroke-width="1.5">
                            <use xlink:href="https://phpstack-1384472-5121645.cloudwaysapps.com/template/html/ki-adm{{asset('dash/assets/svg/_sprite.svg#briefcase-advance"></use>
                        </svg>
                        Advance UI
                ...
                <li class="no-sub">
                    <a href="misc.html">
                        ...
                        <svg stroke="currentColor" stroke-width="1.5">
                            <use xlink:href="https://phpstack-1384472-5121645.cloudwaysapps.com/template/html/ki-adm{{asset('dash/assets/svg/_sprite.svg#rectangle"></use>
                        </svg>
                        Misc
                    </a>
                </li>
                ...
                <li>
                    <a aria-expanded="false" data-bs-toggle="collapse" href="#maps">
                        <svg stroke="currentColor" stroke-width="1.5">
                            <use xlink:href="https://phpstack-1384472-5121645.cloudwaysapps.com/template/html/ki-adm{{asset('dash/assets/svg/_sprite.svg#location"></use>
                        </svg>
                        Map
                    </a>
                ...
                <li>
                    <a aria-expanded="false" data-bs-toggle="collapse" href="#ready_to_use">
                        <svg stroke="currentColor" stroke-width="1.5">
                            <use xlink:href="https://phpstack-1384472-5121645.cloudwaysapps.com/template/html/ki-adm{{asset('dash/assets/svg/_sprite.svg#newspaper"></use>
                        </svg>
                        Ready to use
                ...
                <li>
                    <a aria-expanded="false" data-bs-toggle="collapse" href="#error_pages">
                        <svg stroke="currentColor" stroke-width="1.5">
                            <use xlink:href="https://phpstack-1384472-5121645.cloudwaysapps.com/template/html/ki-adm{{asset('dash/assets/svg/_sprite.svg#exclamation-circle"></use>
                        </svg>
                        Error Pages
                    </a>
                ...
                <li>
                    <a aria-expanded="false" data-bs-toggle="collapse" href="#other_pages">
                        <svg stroke="currentColor" stroke-width="1.5">
                            <use xlink:href="https://phpstack-1384472-5121645.cloudwaysapps.com/template/html/ki-adm{{asset('dash/assets/svg/_sprite.svg#document"></use>
                        </svg>
                        Other Pages
                    </a>
                ...
                <li>
                    <a aria-expanded="false" data-bs-toggle="collapse" href="#level">
                        <svg stroke="currentColor" stroke-width="1.5">
                            <use xlink:href="https://phpstack-1384472-5121645.cloudwaysapps.com/template/html/ki-adm{{asset('dash/assets/svg/_sprite.svg#arrow-down"></use>
                        </svg>
                        2 level
                    </a>
                ...
                <li class="no-sub">
                    <a href="https://phpstack-1384472-5121645.cloudwaysapps.com/document/html/ki-admin/index.html">
                        <svg stroke="currentColor" stroke-width="1.5">
                            <use xlink:href="https://phpstack-1384472-5121645.cloudwaysapps.com/template/html/ki-adm{{asset('dash/assets/svg/_sprite.svg#document-text"></use>
                        </svg>
                        Document
                    </a>
                </li>
                ...
                <li class="no-sub">
                    <a href="mailto:teqlathemes@gmail.com">
                        <svg stroke="currentColor" stroke-width="1.5">
                            <use xlink:href="https://phpstack-1384472-5121645.cloudwaysapps.com/template/html/ki-adm{{asset('dash/assets/svg/_sprite.svg#chat-bubble"></use>
                        </svg>
                        Support
                    </a>
                </li>
                                        ...
                                        <div class="offcanvas-body app-scroll p-0">
                                            <div class="head-container">
                                                <div class="head-box">
                                                  <span class="b-1-light bg-light-primary h-45 w-45 d-flex-center b-r-6">
                                                      <img alt="cart" class="img-fluid p-1"
                                                           src="{{asset('dash/assets/images/header/cart/01.png')}}">
                                                  </span>
                                                ...
                                                <div class="head-box">
                                                    <span class="b-1-light bg-light-primary h-45 w-45 d-flex-center b-r-6">
                                                      <img alt="cart" class="img-fluid p-1"
                                                           src="{{asset('dash/assets/images/header/cart/05.png')}}">
                                                  </span>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a class="mb-0 f-w-600 f-s-16" href="product_details.html"
                                                ...
                                                <div class="head-box">
                                                    <span class="b-1-light bg-light-primary h-45 w-45 d-flex-center b-r-6">
                                                      <img alt="cart" class="img-fluid p-1"
                                                           src="{{asset('dash/assets/images/header/cart/04.png')}}">
                                                  </span>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a class="mb-0 f-w-600 f-s-16" href="product_details.html"
                                                ...
                                                <div class="head-box ">
                                                    <span class="b-1-light bg-light-primary h-45 w-45 d-flex-center b-r-6">
                                                      <img alt="cart" class="img-fluid p-1"
                                                           src="{{asset('dash/assets/images/header/cart/03.png')}}">
                                                  </span>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a class="mb-0 f-w-600 f-s-16" href="product_details.html"
                                                ...
                                                <div class="head-box ">
                                                    <span class="b-1-light bg-light-primary h-45 w-45 d-flex-center b-r-6">
                                                      <img alt="cart" class="img-fluid p-1"
                                                           src="{{asset('dash/assets/images/header/cart/02.png')}}">
                                                  </span>
                                                    <div class="flex-grow-1 ms-2">
                                                        <a class="mb-0 f-w-600 f-s-16" href="product_details.html"
                                                ...
                                                <div class="glass-effect-box position-absolute bottom-0">
                                                    <div class="d-flex align-items-center flex-wrap">
                                                        <div class="w-65 h-65 overflow-hidden position-absolute top-0 start-0 d-flex-center">
                                                            <img alt="image"
                                                                 class="img-fluid"
                                                                 src="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/order1.gif">
                                                        </div>
                            ...
                            <ul class="notifications-list box-list mb-4 ">
                                ...
                                <li class="d-flex align-items-center">
                                    <div class="h-45 w-45 d-flex-center b-r-12 overflow-hidden flex-shrink-0 bg-success-400">
                                        <img alt="order" class="img-fluid" src="{{asset('dash/assets/images/avatar/2.png')}}">
                                    </div>
                                    <div class="ms-3">
                                ...
                                <li class="d-flex align-items-center">
                                    <div class="h-45 w-45 d-flex-center b-r-12 overflow-hidden flex-shrink-0 bg-danger-400">
                                        <img alt="order" class="img-fluid" src="{{asset('dash/assets/images/avatar/5.png')}}">
                                    </div>
                                    <div class="ms-3">
                            ...
                            <ul class=" box-list mb-4">
                                ...
                                <li class="d-flex align-items-center justify-between gap-2">
                                    <div class="b-1-light bg-primary-200 p-1 h-40 w-40 d-flex-center b-r-12 flex-shrink-0 overflow-hidden box-list-img">
                                        <img alt="Smart Watch"
                                             class="img-fluid"
                                             src="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/02.png')}}">
                                    </div>
                                ...
                                <li class="d-flex align-items-center justify-between gap-2">
                                    <div class="b-1-light bg-primary-200 p-1 h-40 w-40 d-flex-center b-r-12 flex-shrink-0 overflow-hidden box-list-img">
                                        <img alt="Smart Watch"
                                             class="img-fluid"
                                             src="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/03.png')}}">
                                    </div>
                                    <div class="mg-s-45 flex-grow-1">
                                ...
                                <li class="d-flex align-items-center justify-between gap-2">
                                    <div class="b-1-light bg-primary-200 p-1 h-40 w-40 d-flex-center b-r-12 flex-shrink-0 overflow-hidden box-list-img">
                                        <img alt="Smart Watch"
                                             class="img-fluid"
                                             src="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/01.png')}}">
                                    </div>
                            ...
                            <ul class="list-box top-brand-list mb-4">
                                ...
                                <li class="d-flex align-items-center">
                                    <div class="b-1-light bg-primary-200 p-1 h-40 w-40 d-flex-center b-r-12 flex-shrink-0 overflow-hidden box-list-img">
                                        <img alt="Smart Watch"
                                             class="img-fluid"
                                             src="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/04.png')}}">
                                    </div>
                                ...
                                <li class="d-flex align-items-center">
                                    <div class="b-1-light bg-primary-200 p-1 h-40 w-40 d-flex-center b-r-12 flex-shrink-0 overflow-hidden box-list-img">
                                        <img alt="Smart Watch"
                                             class="img-fluid"
                                             src="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/06.png')}}">
                                    </div>
                                    <div class="flex-grow-1 mg-s-45">
                                ...
                                <li class="d-flex align-items-center">
                                    <div class="b-1-light bg-primary-200 p-1 h-40 w-40 d-flex-center b-r-12 flex-shrink-0 overflow-hidden box-list-img">
                                        <img alt="Smart Watch"
                                             class="img-fluid"
                                             src="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/07.png')}}">
                                    </div>
                                    <div class="flex-grow-1 mg-s-45">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="row g-2 h-100">
                                                <div class="col-6">
                                                    ...
                                                    <a href="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/product-01.jpg')}}" class="glightbox brand-img-box" data-glightbox="type: image; zoomable: true;">
                                                        <img src="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/product-01.jpg')}}" class="w-100" alt="...">
                                                    </a>
                                                </div>
                                                <div class="col-6 position-relative">
                                                    ...
                                                    <a href="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/product-02.jpg')}}" class="glightbox brand-img-box" data-glightbox="type: image;">
                                                        <img src="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/product-02.jpg')}}" class="w-100" alt="...">
                                                    </a>
                                                </div>
                                                <div class="col-3">
                                                    <a href="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/product-03.jpg')}}" class="glightbox brand-img-box" data-glightbox="type: image;">
                                                        <img src="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/product-03.jpg')}}" class="w-100" alt="...">
                                                    </a>
                                                </div>
                                                <div class="col-3">
                                                    <a href="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/product-04.jpg')}}" class="glightbox brand-img-box" data-glightbox="type: image;">
                                                        <img src="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/product-04.jpg')}}" class="w-100" alt="...">
                                                    </a>
                                                </div>
                                                <div class="col-3">
                                                    <a href="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/product-05.jpg')}}" class="glightbox brand-img-box" data-glightbox="type: image;">
                                                        <img src="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/product-05.jpg')}}" class="w-100" alt="...">
                                                    </a>
                                                </div>
                                                <div class="col-3">
                                                    <a href="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/product-06.jpg')}}" class="glightbox brand-img-box" data-glightbox="type: image;">
                                                        <img src="{{asset('dash/assets/images/dashboard/ecommerce-dashboard/product/product-06.jpg')}}" class="w-100 rounded" alt="...">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content welcome-card">
            ...
            <div class="modal-body p-0">
                <div>
                    <img alt="img" class=" img-fluid" src="{{asset('dash/assets/images/modals/welcome-bg.png')}}" >
                    <div>
                        <img src="{{asset('dash/assets/images/modals/welcome-rocket.png')}}" class="modal-rocket img-fluid" alt="img">
                    </div>
                </div>
...
<!-- Simple bar js-->
<script src="{{asset('dash/assets/vendor/simplebar/simplebar.js')}}"></script>

<!-- phosphor js -->
<script src="{{asset('dash/assets/vendor/phosphor/phosphor.js')}}"></script>

<!-- Glight js -->
<script src="{{asset('dash/assets/vendor/glightbox/glightbox.min.js')}}"></script>
...
<!-- Ecommerce js-->
<script src="{{asset('dash/assets/js/ecommerce_dashboard.js')}}"></script>
...
<!-- Mirrored from phpstack-1384472-5121645.cloudwaysapps.com/template/html/ki-admin/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Jun 2025 19:47:17 GMT -->
</html>